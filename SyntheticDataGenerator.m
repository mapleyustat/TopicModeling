...
% docID wordID counts
fid = fopen('TopicModelingSingleNodeALS\TopicModel\datasets\synthetic\samples_train.txt','wt');
for index_doc = 1: n
    for index_word = 1:d
...
fid = fopen('TopicModelingSingleNodeALS\TopicModel\datasets\synthetic\samples_test.txt','wt');
